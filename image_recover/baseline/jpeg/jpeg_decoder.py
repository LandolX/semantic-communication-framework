...
class JPEGDecoder:
    ...
    def _try_open_jpeg(self, data):
        """
        尝试以JPEG格式打开数据
        :param data: JPEG格式的bytes数据
    ...
    def decode_image(self, framed_data, return_type='pil', default_size=(776, 776)):
        ...
        if frame_type == 'block_jpeg' and self.use_block_codec:
            ...
            if jpeg_data:
                ...
                image = self._try_open_jpeg(jpeg_data)
                if image is not None:
                    ...
                    print(f"JPEG分块解码成功，恢复图像尺寸: {image.size}")
                    ...
                    if jpeg_data:
                        ...
                        if image is not None:
                            ...
                            print(f"JPEG分块解码成功（回退），恢复图像尺寸: {image.size}")
            ...
            if jpeg_data:
                ...
                if image is not None:
                    ...
                    print(f"JPEG传统解码成功，恢复图像尺寸: {image.size}")
...
if __name__ == "__main__":
    ...
    from image_process.baseline.jpeg.jpeg_encoder import jpeg_encode_from_file
